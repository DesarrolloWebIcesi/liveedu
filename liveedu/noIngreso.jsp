...
<%session.invalidate();%>
	<br/><br/>
	<logic:notEmpty name="noIngreso" scope="request">
		<SPAN class="titulo">Usted no puede acceder a este servicio.</SPAN>
	</logic:notEmpty>
	<br/><br/>
	<SPAN class="titulo">Su sesión ha finalizado.</SPAN>
	<br/><br/><br/><br/>
</td></tr></table></td>
</tr>
<tr>
